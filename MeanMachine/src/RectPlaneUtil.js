class RectPlaneUtil{
    static RectPlaneXYoverlapsRectPlaneXY(plane0, plane1){
    ...
    static RectPlaneZYoverlapsRectPlaneZY(plane0, plane1){
    ...
    static RectPlaneXZoverlapsRectPlaneXZ(plane0, plane1){
